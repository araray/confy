...
"""Unit tests for :mod:`confy.tokens`."""
...
import confy.tokens as tokens
from confy.tokens import EstimateCounter, TiktokenCounter, count_tokens, get_counter
...
class TestCountTokens:
    def test_missing_tiktoken_falls_back_to_estimate(self, monkeypatch, caplog) -> None:
        ...
        with caplog.at_level("WARNING", logger="confy.tokens"):
